...
/**
 * Video frame consumer interface. You may need to implement this interface
 * if you want to render video frames.
 * 
...
public interface IVideoFrameConsumer {
    ...
    /**
     * This method will be called by the video frame producer. It delivers
     * video frames.
     * 
     ...
     */
    void processFrame(Object producer, VideoFrame frame) throws LibavException;
