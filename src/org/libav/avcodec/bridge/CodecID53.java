...
/**
 * Mirror of the native CodecID enum for the libavcodec v53.x.x. For details 
 * see the Libav documentation.
 * 
 * @author Ondrej Perutka
 */
public interface CodecID53 {
    ...
    public static final int CODEC_ID_FFH264 = (int)100;
    public static final int CODEC_ID_DXA = (int)101;
    public static final int CODEC_ID_DNXHD = (int)102;
    public static final int CODEC_ID_THP = (int)103;
    public static final int CODEC_ID_SGI = (int)104;
    public static final int CODEC_ID_C93 = (int)105;
    public static final int CODEC_ID_BETHSOFTVID = (int)106;
    public static final int CODEC_ID_PTX = (int)107;
    public static final int CODEC_ID_TXD = (int)108;
    public static final int CODEC_ID_VP6A = (int)109;
    public static final int CODEC_ID_AMV = (int)110;
    public static final int CODEC_ID_VB = (int)111;
    public static final int CODEC_ID_PCX = (int)112;
    public static final int CODEC_ID_SUNRAST = (int)113;
    public static final int CODEC_ID_INDEO4 = (int)114;
    public static final int CODEC_ID_INDEO5 = (int)115;
    public static final int CODEC_ID_MIMIC = (int)116;
    public static final int CODEC_ID_RL2 = (int)117;
    public static final int CODEC_ID_8SVX_EXP = (int)118;
    public static final int CODEC_ID_8SVX_FIB = (int)119;
    public static final int CODEC_ID_ESCAPE124 = (int)120;
    public static final int CODEC_ID_DIRAC = (int)121;
    public static final int CODEC_ID_BFI = (int)122;
    public static final int CODEC_ID_CMV = (int)123;
    public static final int CODEC_ID_MOTIONPIXELS = (int)124;
    public static final int CODEC_ID_TGV = (int)125;
    public static final int CODEC_ID_TGQ = (int)126;
    public static final int CODEC_ID_TQI = (int)127;
    public static final int CODEC_ID_AURA = (int)128;
    public static final int CODEC_ID_AURA2 = (int)129;
    public static final int CODEC_ID_V210X = (int)130;
    public static final int CODEC_ID_TMV = (int)131;
    public static final int CODEC_ID_V210 = (int)132;
    public static final int CODEC_ID_DPX = (int)133;
    public static final int CODEC_ID_MAD = (int)134;
    public static final int CODEC_ID_FRWU = (int)135;
    public static final int CODEC_ID_FLASHSV2 = (int)136;
    public static final int CODEC_ID_CDGRAPHICS = (int)137;
    public static final int CODEC_ID_R210 = (int)138;
    public static final int CODEC_ID_ANM = (int)139;
    public static final int CODEC_ID_BINKVIDEO = (int)140;
    public static final int CODEC_ID_IFF_ILBM = (int)141;
    public static final int CODEC_ID_IFF_BYTERUN1 = (int)142;
    public static final int CODEC_ID_KGV1 = (int)143;
    public static final int CODEC_ID_YOP = (int)144;
    public static final int CODEC_ID_VP8 = (int)145;
    public static final int CODEC_ID_PICTOR = (int)146;
    public static final int CODEC_ID_ANSI = (int)147;
    public static final int CODEC_ID_A64_MULTI = (int)148;
    public static final int CODEC_ID_A64_MULTI5 = (int)149;
    public static final int CODEC_ID_R10K = (int)150;
    public static final int CODEC_ID_MXPEG = (int)151;
    public static final int CODEC_ID_LAGARITH = (int)152;
    public static final int CODEC_ID_PRORES = (int)153;
    public static final int CODEC_ID_JV = (int)154;
    public static final int CODEC_ID_DFA = (int)155;
    public static final int CODEC_ID_WMV3IMAGE = (int)156;
    public static final int CODEC_ID_VC1IMAGE = (int)157;

    /// various PCM "codecs"
    public static final int CODEC_ID_FIRST_AUDIO = (int)65536;
    public static final int CODEC_ID_PCM_S16LE = (int)65536;
    ...
    public static final int CODEC_ID_ADPCM_IMA_QT = (int)69632;
    ...
    /// AMR
    public static final int CODEC_ID_AMR_NB = (int)73728;
    public static final int CODEC_ID_AMR_WB = (int)73729;

    /// RealAudio codecs
    public static final int CODEC_ID_RA_144 = (int)77824;
    public static final int CODEC_ID_RA_288 = (int)77825;

    /// various DPCM codecs
    public static final int CODEC_ID_ROQ_DPCM = (int)81920;
    ...
    /// audio codecs
    public static final int CODEC_ID_MP2 = (int)86016;
    ...
    public static final int CODEC_ID_SONIC = (int)86028;
    public static final int CODEC_ID_SONIC_LS = (int)86029;
    public static final int CODEC_ID_FLAC = (int)86030;
    public static final int CODEC_ID_MP3ADU = (int)86031;
    public static final int CODEC_ID_MP3ON4 = (int)86032;
    public static final int CODEC_ID_SHORTEN = (int)86033;
    public static final int CODEC_ID_ALAC = (int)86034;
    public static final int CODEC_ID_WESTWOOD_SND1 = (int)86035;
    public static final int CODEC_ID_GSM = (int)86036;
    public static final int CODEC_ID_QDM2 = (int)86037;
    public static final int CODEC_ID_COOK = (int)86038;
    public static final int CODEC_ID_TRUESPEECH = (int)86039;
    public static final int CODEC_ID_TTA = (int)86040;
    public static final int CODEC_ID_SMACKAUDIO = (int)86041;
    public static final int CODEC_ID_QCELP = (int)86042;
    public static final int CODEC_ID_WAVPACK = (int)86043;
    public static final int CODEC_ID_DSICINAUDIO = (int)86044;
    public static final int CODEC_ID_IMC = (int)86045;
    public static final int CODEC_ID_MUSEPACK7 = (int)86046;
    public static final int CODEC_ID_MLP = (int)86047;

    /// as found in WAV
    public static final int CODEC_ID_GSM_MS = (int)86048;
    public static final int CODEC_ID_ATRAC3 = (int)86049;
    public static final int CODEC_ID_VOXWARE = (int)86050;
    public static final int CODEC_ID_APE = (int)86051;
    public static final int CODEC_ID_NELLYMOSER = (int)86052;
    public static final int CODEC_ID_MUSEPACK8 = (int)86053;
    public static final int CODEC_ID_SPEEX = (int)86054;
    public static final int CODEC_ID_WMAVOICE = (int)86055;
    public static final int CODEC_ID_WMAPRO = (int)86056;
    public static final int CODEC_ID_WMALOSSLESS = (int)86057;
    public static final int CODEC_ID_ATRAC3P = (int)86058;
    public static final int CODEC_ID_EAC3 = (int)86059;
    public static final int CODEC_ID_SIPR = (int)86060;
    public static final int CODEC_ID_MP1 = (int)86061;
    public static final int CODEC_ID_TWINVQ = (int)86062;
    public static final int CODEC_ID_TRUEHD = (int)86063;
    public static final int CODEC_ID_MP4ALS = (int)86064;
    public static final int CODEC_ID_ATRAC1 = (int)86065;
    public static final int CODEC_ID_BINKAUDIO_RDFT = (int)86066;
    public static final int CODEC_ID_BINKAUDIO_DCT = (int)86067;
    public static final int CODEC_ID_AAC_LATM = (int)86068;
    public static final int CODEC_ID_QDMC = (int)86069;
    public static final int CODEC_ID_CELT = (int)86070;

    /// subtitle codecs
    public static final int CODEC_ID_FIRST_SUBTITLE = (int)94208;
    public static final int CODEC_ID_DVD_SUBTITLE = (int)94208;
    ...
    public static final int CODEC_ID_FIRST_UNKNOWN = (int)98304;
    public static final int CODEC_ID_TTF = (int)98304;
    public static final int CODEC_ID_PROBE = (int)102400;
    public static final int CODEC_ID_MPEG2TS = (int)131072;
    public static final int CODEC_ID_FFMETADATA = (int)135168;
