...
public class OutputFormatWrapper53 extends AbstractOutputFormatWrapper {
    ...
    public static OutputFormatWrapper53 guessFormat(String shortName, String fileName, String mimeType) {
        ...
        return new OutputFormatWrapper53(new AVOutputFormat53(result));
    }
